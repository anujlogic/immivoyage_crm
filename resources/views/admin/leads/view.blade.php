    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card card-primary">  
				...
				<h3 class="card-title">View New Lead</h3>
				</div>
				<form role="form" method="post" action="{{ route('call.update') }}" enctype="multipart/form-data">
					@csrf
					<div class="card-body">
						<div class="form-group">
							@if($call_lead->enroll=='no')
								<h4 style="color:red;"> {{ $call_lead->name }} Not Enroll yet </h4>
							@else
								<h3 style="color:red;"> {{ $call_lead->enroll }} Already Enrolled</h3>
							@endif
					  	</div>
			  			<div class="form-group col-md-6">
			                <label>Leads Category</label>
		                    <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" name="lead_category" id="lead_category" disabled>
					  	...
					  	<div class="form-group">
					    	...
					    	<input type="text" class="form-control" id="exampleInputName" name="name" placeholder="Enter name" value="{{ $call_lead->name }}" disabled>
					    	<input type="hidden" name="id" value="{{ $call_lead->id }}">
					  	</div>
					  	<div class="form-group">
					    	<label for="exampleInputContact">Mobile No</label>
					    	<input type="number" class="form-control" id="exampleInputContact" name="mobile_no" placeholder="Enter mobile no" value="{{ $call_lead->contact_no }}" disabled>
					  	</div>
					  	<div class="form-group">
					    	<label for="exampleInputAge">Age</label>
					    	<input type="number" class="form-control" id="exampleInputAge" name="age"  placeholder="Enter age" value="{{ $call_lead->age }}" disabled>
					  	</div>
					  	<div class="form-group">
					    	<label for="exampleInputEmail1">Email address</label>
					    	<input type="email" class="form-control" id="exampleInputEmail1" name="email" placeholder="Enter email" value="{{ $call_lead->email }}" disabled>
					    </div>
					    <div class="form-group">
					    	<label for="exampleInputEmail1">Qualification</label>
					    	<input type="text" class="form-control" id="exampleInputEmail1" name="qualification" placeholder="Enter Qualification" value="{{ $call_lead->qualification }}" disabled>
					    </div>
					    <div class="form-group">
					    	<label for="exampleInputAddress">Address</label>
					    	<input type="text" class="form-control" id="exampleInputAddress" name="address" placeholder="Enter address" value="{{ $call_lead->address }}" disabled>
					    </div>
					    <div class="form-group col-md-6">
			                <label>Call Purpose</label>
		                    <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" name="call_purpose" id="call_purpose" disabled>
			                    <option selected="selected" disabled>Select...</option>
                  	...
                  	@if($call_lead->call_purpose == 'visa')
	                  	<div class="row" id="visa">
	                  		<div class="form-group col-md-12" id="visa_category">
			                    ...
			                    <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" name="visa_category" disabled>
				                    <option selected="selected" disabled>Select...</option>
	                  		...
	                  		<div class="form-group col-md-12" id="score">
						    	...
						    	<input type="number" class="form-control" id="exampleInputScore" name="ielts_score" placeholder="Enter Score" value="{{ $call_lead->ielts_score }}" disabled>
					    	</div>
		                    <div class="form-group col-md-3" id="listen">
		                    	<label for="exampleInputEnglish">Listen</label>
		                    	<input type="text" class="form-control" name="listen_score" placeholder="Enter score" value="{{ $call_lead->listen }}" disabled>
		                  	</div>
		                  	<div class="form-group col-md-3" id="write">
		                    	<label for="exampleInputEnglish">Write</label>
		                    	<input type="text" class="form-control" name="write_score" placeholder="Enter score" value="{{ $call_lead->wirte }}" disabled>
		                  	</div>
		                  	<div class="form-group col-md-3" id="read">
		                    	<label for="exampleInputEnglish">Read</label>
		                    	<input type="text" class="form-control" name="read_score" placeholder="Enter score" value="{{ $call_lead->read }}" disabled>
		                  	</div>
		                  	<div class="form-group col-md-3" id="speak">
		                    	<label for="exampleInputEnglish">Speak</label>
		                    	<input type="text" class="form-control" name="speak_score" placeholder="Enter score" value="{{ $call_lead->speak }}" disabled>
		                  	</div>
		                  	<div class="form-group col-md-12" id="desire_country">
			                	<label>Desire Country</label>
			                    <select class="form-control select2  desire_country" data-dropdown-css-class="select2-danger" style="width: 100%;" name="desire_country" disabled>
				                    <option selected="selected" disabled>Select...</option>
              		...
              		@if($call_lead->call_purpose == 'ielts')
	              		<div class="row" id="ielts">
	              			<div class="form-group col-md-12" id="ieltsScore">
						    	<label for="exampleInputScore">IELTS Score</label>
						    	<input type="number" class="form-control" id="exampleInputScore" name="ieltsScore" placeholder="Enter Score" value="{{ $call_lead->ielts_score }}" disabled>
					    	</div>
		                    <div class="form-group col-md-3" id="ieltsListen">
		                    	<label for="exampleInputEnglish">Listen</label>
		                    	<input type="text" class="form-control" name="ieltsListen" placeholder="Enter score" value="{{ $call_lead->listen }}" disabled>
		                  	</div>
		                  	<div class="form-group col-md-3" id="ieltsWrite">
		                    	<label for="exampleInputEnglish">Write</label>
		                    	<input type="text" class="form-control" name="ieltsWrite" placeholder="Enter score" value="{{ $call_lead->wirte }}" disabled>
		                  	</div>
		                  	<div class="form-group col-md-3" id="ieltsRead">
		                    	<label for="exampleInputEnglish">Read</label>
		                    	<input type="text" class="form-control" name="ieltsRead" placeholder="Enter score" value="{{ $call_lead->read }}" disabled>
		                  	</div>
		                  	<div class="form-group col-md-3" id="ieltsSpeak">
		                    	<label for="exampleInputEnglish">Speak</label>
		                    	<input type="text" class="form-control" name="ieltsSpeak" placeholder="Enter score" value="{{ $call_lead->speak }}" disabled>
		                  	</div>
		                  	<div class="form-group col-md-12" id="ieltsBand">
						    	<label for="exampleInputScore">Required Band</label>
						    	<input type="number" class="form-control" id="exampleInputScore" name="ieltsBand" placeholder="Enter Score" value="{{ $call_lead->require_band }}" disabled>
					    	</div>
					    	<div class="form-group col-md-6" id="ielts_test">
				                <label>Required Test</label>
			                    <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" name="ielts_test" id="ielts" disabled>
				                    <option selected="selected" disabled>Select...</option>
              		...
              		<div class="form-group col-md-6" id="call_manage_by">
	                    ...
	                    <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" name="call_manage_by" id="call_manage_by" disabled>
		                    <option selected="selected" disabled>Select...</option>
                  	...
                  	<div class="form-group col-md-6" id="feed_back">
                        ...
                        <textarea class="form-control" name="feed_back" rows="3" placeholder="Enter ..." disabled>{{ $call_lead->feed_back }}</textarea>
                    </div>
                    <div class="form-group col-md-6" > 
	                    <label>Follow Up</label>
	                    <div class="input-group date" id="reservationdatetime" data-target-input="nearest" id="follow_up">
	                        <input type="text" name="follow_up" class="form-control datetimepicker-input" data-target="#reservationdatetime" value="{{ $call_lead->follow_up }}" disabled>
